function HRVparams = InitializeHRVparams(project_name, matFiles)
%
...
switch project_name   
    ...
    case 'BSPHRV'                % Update with your project name
        HRVparams.Fs = 200;                % Spacify sampling frequency
        HRVparams.readdata = '';           % (Optional) Specify name for data input folder
        HRVparams.writedata = matFiles;    % (Optional) Specify name for data output folder
...
%% 14. Entropy Settings
% Multiscale Entropy
HRVparams.MSE.on = 0;                      % Default: 1, MSE Analysis 1=On or 0=Off
...
HRVparams.DFA.on = 0;               % Default: 1, DFA Analysis 1=On or 0=Off
